namespace CourseProject.Domain.Common.Exceptions;
...
public record FuncResult<T>
{
    ...
    /// <summary>
    /// Gets the exception if the operation encounters the error, otherwise, is null.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the `FuncResult`.
    /// Class with successful data.
    /// </summary>
    ...
    /// </summary>
    /// <param name="exception">Th exception encountered during the operation.</param>
